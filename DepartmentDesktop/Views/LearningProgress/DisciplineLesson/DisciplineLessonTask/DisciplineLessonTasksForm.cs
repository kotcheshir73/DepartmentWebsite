...
{
    public partial class DisciplineLessonTasksForm : Form
    {
        [Dependency]
        ...
        public DisciplineLessonTasksForm(ILearningProgressProcess process, Guid? dlId)
        {
            InitializeComponent();
            _process = process;
            _dlId = dlId;
        ...
        private void DisciplineLessonTasksForm_Load(object sender, EventArgs e)
        {
