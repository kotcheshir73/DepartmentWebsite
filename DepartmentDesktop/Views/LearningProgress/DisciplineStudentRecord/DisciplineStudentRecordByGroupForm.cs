...
{
    public partial class DisciplineStudentRecordByGroupForm : Form
    {
        [Dependency]
        ...
        public DisciplineStudentRecordByGroupForm(IDisciplineStudentRecordService service, Guid? dId = null, Guid? sgId = null, string semester = null)
        {
            InitializeComponent();
            _service = service;
            _dId = dId;
        ...
        private void DisciplineStudentRecordByGroupForm_Load(object sender, EventArgs e)
        {
