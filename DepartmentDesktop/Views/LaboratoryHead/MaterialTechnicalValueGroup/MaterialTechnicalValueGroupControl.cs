...
{
    public partial class MaterialTechnicalValueGroupControl : UserControl
    {
        [Dependency]
        ...
        public MaterialTechnicalValueGroupControl(IMaterialTechnicalValueGroupService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<MaterialTechnicalValueGroupForm>(
                new ParameterOverrides
                {
                    { "id", Guid.Empty }
                }
                .OnType<MaterialTechnicalValueGroupForm>());
