...
{
    public partial class ProgressPracticsControl : UserControl
    {
        [Dependency]
        ...
        public ProgressPracticsControl(IDisciplineService serviceD, IDisciplineLessonService serviceDL)
        {
            InitializeComponent();
            _serviceD = serviceD;
            ...
            standartControl.GetPageAddEvent(LoadPrRecords);
        ...
        public int LoadPrRecords(int pageNumber, int pageSize)
        {
            ...
            {
                if (res.LessonType == DisciplineLessonTypes.практика)
                {
