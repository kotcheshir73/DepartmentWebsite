...
{
    public partial class ProgressLabsControl : UserControl
    {
        [Dependency]
        ...
        public ProgressLabsControl(IDisciplineService serviceD, IDisciplineLessonService serviceDL)
        {
            InitializeComponent();
            _serviceD = serviceD;
            ...
            standartControl.GetPageAddEvent(LoadLabRecords);
        ...
        public int LoadLabRecords(int pageNumber, int pageSize)
        {
            ...
            {
                if (res.LessonType == DisciplineLessonTypes.лабораторная)
                {
