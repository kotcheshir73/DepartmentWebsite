...
{
    public partial class ProgressLecturesControl : UserControl
    {
        [Dependency]
        ...
        public ProgressLecturesControl(IDisciplineService serviceD, IDisciplineLessonService serviceDL)
        {
            InitializeComponent();
            _serviceD = serviceD;
            ...
            standartControl.GetPageAddEvent(LoadLecRecords);
        ...
        public int LoadLecRecords(int pageNumber, int pageSize)
        {
            ...
            {
                if (res.LessonType == DisciplineLessonTypes.лекция)
                {
