...
{
	partial class ScheduleExaminationLecturerControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.ColumnWeek1Lesson3.DefaultCellStyle = dataGridViewCellStyle2;
			...
			this.ColumnWeek1Lesson1.DefaultCellStyle = dataGridViewCellStyle3;
			...
			this.dataGridViewFirstWeek.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			// 
			// ScheduleExaminationLecturerControl
			// 
