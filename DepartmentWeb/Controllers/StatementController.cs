...
namespace DepartmentWeb.Controllers
{
    public class StatementController : Controller
    {
        ...
        {            
            var tmpAY = _serviceAY.GetAcademicYears(new AcademicYearGetBindingModel());
            var tmpL = _serviceL.GetLecturer(new LecturerGetBindingModel() { Id = new Guid("0F121F0F-5BEF-4BAD-AE3F-DF06CD435EC7") });

            var tuple = new Tuple<AcademicYearPageViewModel, LecturerViewModel>(tmpAY.Result, tmpL.Result);
        ...
        */
        ...
        //[HttpPost]
        //public ActionResult StatementRecord(List<StatementRecordViewModel> statementRecordViewModels)
        //{
