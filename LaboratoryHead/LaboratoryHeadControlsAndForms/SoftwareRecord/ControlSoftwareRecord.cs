...
{
    public partial class ControlSoftwareRecord : UserControl
    {
        [Dependency]
        ...
        public ControlSoftwareRecord(ISoftwareRecordService service, ILaboratoryProcess process)
        {
            InitializeComponent();
            _service = service;
            _process = process;
        ...
        {
            var form = Container.Resolve<FormSoftwareRecord>(
                new ParameterOverrides
                {
                    { "id", Guid.Empty }
                }
                .OnType<FormSoftwareRecord>());
        ...
        {
            var form = Container.Resolve<FormInstallSowtware>();
            form.Show();
        }

        private void UnInstallSowtwareToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var form = Container.Resolve<FormUnInstallSowtware>();
            form.Show();
        }
