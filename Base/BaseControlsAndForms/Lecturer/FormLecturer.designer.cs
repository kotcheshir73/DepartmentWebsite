namespace BaseControlsAndForms.Lecturer
{
	partial class LecturerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelLecturerStudyPost = new System.Windows.Forms.Label();
			this.comboBoxLecturerStudyPost = new System.Windows.Forms.ComboBox();
			...
			this.panelMain.Controls.Add(this.comboBoxLecturerStudyPost);
			this.panelMain.Controls.Add(this.labelLastName);
			this.panelMain.Controls.Add(this.labelLecturerStudyPost);
			...
			// 
			// labelLecturerStudyPost
			// 
			this.labelLecturerStudyPost.AutoSize = true;
			this.labelLecturerStudyPost.Location = new System.Drawing.Point(12, 272);
			this.labelLecturerStudyPost.Name = "labelLecturerStudyPost";
			this.labelLecturerStudyPost.Size = new System.Drawing.Size(72, 13);
			this.labelLecturerStudyPost.TabIndex = 18;
			this.labelLecturerStudyPost.Text = "Должность*:";
			// 
			// comboBoxLecturerStudyPost
			// 
			this.comboBoxLecturerStudyPost.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxLecturerStudyPost.FormattingEnabled = true;
			this.comboBoxLecturerStudyPost.Location = new System.Drawing.Point(126, 269);
			this.comboBoxLecturerStudyPost.Name = "comboBoxLecturerStudyPost";
			this.comboBoxLecturerStudyPost.Size = new System.Drawing.Size(200, 21);
			this.comboBoxLecturerStudyPost.TabIndex = 19;
			// 
        ...
        private System.Windows.Forms.Label labelLecturerStudyPost;
        private System.Windows.Forms.ComboBox comboBoxLecturerStudyPost;
