...
{
    public partial class FormLongAcadem : Form
    {
        [Dependency]
        ...
        public FormLongAcadem(IStudentService serviceS, IProcess process, List<Guid> ids)
        {
            InitializeComponent();
            _serviceS = serviceS;
            _process = process;
        ...
        private void FormLongAcadem_Load(object sender, EventArgs e)
        {
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            var result = _process.LongAcademStudents(new StudentAcademBindingModel
            {
