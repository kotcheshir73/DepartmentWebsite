...
{
    public partial class ControlDisciplineBlock : UserControl
    {
        [Dependency]
		...
		public ControlDisciplineBlock(IDisciplineBlockService service)
		{
			InitializeComponent();
			_service = service;
		...
		{
            var form = Container.Resolve<FormDisciplineBlock>(
                new ParameterOverrides
                {
                    { "id", Guid.Empty }
                }
                .OnType<FormDisciplineBlock>());
