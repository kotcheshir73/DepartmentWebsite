...
{
    public partial class ControlScheduleLessonTime : UserControl
    {
        [Dependency]
        ...
        public ControlScheduleLessonTime(IScheduleLessonTimeService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormScheduleLessonTime>(
                new ParameterOverrides
                {
                    { "id", Guid.Empty }
                }
                .OnType<FormScheduleLessonTime>());
