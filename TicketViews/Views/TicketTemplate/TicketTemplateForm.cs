...
{
    public partial class TicketTemplateForm : Form
    {
        [Dependency]
        ...
        public TicketTemplateForm(ITicketTemplateService service, IExaminationTemplateService _serviceET, ITicketProcess process, Guid? examinationTemplateId = null, Guid? id = null)
        {
            InitializeComponent();
            _service = service;
            _process = process;
        ...
        private void TicketTemplateForm_Load(object sender, EventArgs e)
        {
            if (_id.HasValue)
            {
                LoadData();
        ...
        private void ButtonLoadTemplate_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    Program.PrintErrorMessage("При загрузке возникла ошибка: ", template.Errors);
                }
            }
        }
    }
