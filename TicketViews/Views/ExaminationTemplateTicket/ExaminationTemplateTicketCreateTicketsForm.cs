...
{
    public partial class ExaminationTemplateTicketCreateTicketsForm : Form
    {
        [Dependency]
        ...
        public ExaminationTemplateTicketCreateTicketsForm(ITicketProcess process, IExaminationTemplateBlockService serviceB, Guid examinationTemplateId)
        {
            InitializeComponent();
            _process = process;
        ...
        private void ExaminationTemplateTicketCreateTicketsForm_Load(object sender, EventArgs e)
        {
            ...
            {
                Program.PrintErrorMessage("При удалении возникла ошибка: ", blocks.Errors);
            }
        }
