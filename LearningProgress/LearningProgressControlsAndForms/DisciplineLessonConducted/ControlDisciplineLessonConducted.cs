...
{
    public partial class ControlDisciplineLessonConducted : UserControl
    {
        [Dependency]
        ...
        public ControlDisciplineLessonConducted(IDisciplineLessonConductedService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormDisciplineLessonConducted>(
                ...
                .OnType<FormDisciplineLessonConducted>());
        ...
        {
            var form = Container.Resolve<ReportLessonConducted>(
                new ParameterOverrides
                {
                    { "ayId", _ayId },
                    { "edId", _edId },
