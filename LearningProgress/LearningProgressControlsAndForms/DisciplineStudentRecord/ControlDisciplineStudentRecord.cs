...
{
    public partial class ControlDisciplineStudentRecord : UserControl
    {
        [Dependency]
        ...
        public ControlDisciplineStudentRecord(IDisciplineStudentRecordService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormDisciplineStudentRecord>(
                ...
                .OnType<FormDisciplineStudentRecord>());
        ...
        {
            var form = Container.Resolve<FormFillGroup>(
                new ParameterOverrides
                {
                    { "dId", _dId },
                    { "sgId", _sgId },
        ...
        {
            var form = Container.Resolve<ReportDisciplineStudentRecordByGroup>(
                new ParameterOverrides
                {
                    { "dId", _dId },
                    { "sgId", _sgId },
                ...
                .OnType<ReportDisciplineStudentRecordByGroup>());
            form.ShowDialog();
        }

        private void PrintSubgroupsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var form = Container.Resolve<ReportDisciplineStudentRecordBySubgroup>(
                new ParameterOverrides
                {
                    { "dId", _dId },
                    { "sgId", _sgId },
                ...
                .OnType<ReportDisciplineStudentRecordBySubgroup>());
            form.ShowDialog();
        }
    }
}