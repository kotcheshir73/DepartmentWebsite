...
{
    public partial class ReportDisciplineStudentRecordByGroup : Form
    {
        [Dependency]
        ...
        public ReportDisciplineStudentRecordByGroup(IDisciplineStudentRecordService service, Guid? dId = null, Guid? sgId = null, string semester = null)
        {
            InitializeComponent();
            _service = service;
            _dId = dId;
        ...
        private void ReportDisciplineStudentRecordByGroup_Load(object sender, EventArgs e)
        {
