...
{
    public partial class ReportDisciplineLessonVariants : Form
    {
        [Dependency]
        ...
        public ReportDisciplineLessonVariants(ILearningProgressProcess process, Guid? dlId)
        {
            InitializeComponent();
            _process = process;
            _dlId = dlId;
        ...
        private void ReportDisciplineLessonVariants_Load(object sender, EventArgs e)
        {
