...
{
    public partial class FormCreateAssignTasks : Form
    {
        [Dependency]
        ...
        public FormCreateAssignTasks(ILearningProgressProcess process, IDisciplineLessonTaskStudentAcceptService service, Guid dlId, Guid sgId)
        {
            InitializeComponent();
            _process = process;
            _service = service;
        ...
        private void FormCreateAssignTasks_Load(object sender, EventArgs e)
        {
