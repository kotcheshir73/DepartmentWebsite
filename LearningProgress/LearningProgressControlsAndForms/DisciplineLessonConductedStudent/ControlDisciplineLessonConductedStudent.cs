...
{
    public partial class ControlDisciplineLessonConductedStudent : UserControl
    {
        [Dependency]
        ...
        public ControlDisciplineLessonConductedStudent(IDisciplineLessonConductedStudentService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormDisciplineLessonConductedStudent>(
                ...
                .OnType<FormDisciplineLessonConductedStudent>());
        ...
        {
            var form = Container.Resolve<FormFillStudents>(
                new ParameterOverrides
                {
                    { "dlcId", _dlcId },
                    { "sgId", _sgId }
                }
                .OnType<FormFillStudents>());
            if (form.ShowDialog() == DialogResult.OK)
            {
                standartControl.LoadPage();
            }
