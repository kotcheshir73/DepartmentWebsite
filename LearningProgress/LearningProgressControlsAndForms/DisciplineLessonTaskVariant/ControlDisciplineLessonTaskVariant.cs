...
{
    public partial class ControlDisciplineLessonTaskVariant : UserControl
    {
        [Dependency]
        ...
        public ControlDisciplineLessonTaskVariant(IDisciplineLessonTaskVariantService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormDisciplineLessonTaskVariant>(new ParameterOverrides
                {
                    { "dltId", _dltId },
                    { "id", Guid.Empty}
                }
                .OnType<FormDisciplineLessonTaskVariant>());
        ...
        private void UpdRecord()
        {
            if (standartControl.GetDataGridViewSelectedRows.Count == 1)
            {
                ...
                var form = Container.Resolve<FormDisciplineLessonTaskVariant>(
        ...
        {
            var form = Container.Resolve<FormDisciplineLessonTaskVariants>(
                new ParameterOverrides
                {
                    { "dltId", _dltId }
                }
                .OnType<FormDisciplineLessonTaskVariants>());
            form.Show();
        }
    }
}