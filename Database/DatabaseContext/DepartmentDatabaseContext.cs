...
#if RELEASE
				optionsBuilder.UseSqlServer(@"Data Source=10.3.63.13\SQLEXPRESS;Initial Catalog=DepartmentDatabaseContext;persist security info=True;user id=sa;password=isadmin;MultipleActiveResultSets=True;");
#endif
