...
{
    public partial class ControlExaminationTemplate : UserControl
    {
        [Dependency]
        ...
        public ControlExaminationTemplate(IExaminationTemplateService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormExaminationTemplate>(
                new ParameterOverrides
                {
                    { "id", Guid.Empty }
                }
                .OnType<FormExaminationTemplate>());
