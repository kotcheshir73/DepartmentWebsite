        ...
        private TicketTemplate GetTicketTemplate(Guid examinationTemplateId)
        {
            using (var context = DepartmentUserManager.GetContext)
            {
                return context.ExaminationTemplates
                    ...
                    .Include("TicketTemplate.TicketTemplateBodies")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateBodyProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateParagraphs")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateParagraphs.TicketTemplateParagraphProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateParagraphs.TicketTemplateParagraphRuns")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateParagraphs.TicketTemplateParagraphRuns.TicketTemplateParagraphRunProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableGridColumns")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableRowProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells.TicketTemplateTableCellProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells.TicketTemplateParagraphs")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells.TicketTemplateParagraphs.TicketTemplateParagraphProperties")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells.TicketTemplateParagraphs.TicketTemplateParagraphRuns")
                    .Include("TicketTemplate.TicketTemplateBodies.TicketTemplateTables.TicketTemplateTableRows.TicketTemplateTableCells.TicketTemplateParagraphs.TicketTemplateParagraphRuns.TicketTemplateParagraphRunProperties")
