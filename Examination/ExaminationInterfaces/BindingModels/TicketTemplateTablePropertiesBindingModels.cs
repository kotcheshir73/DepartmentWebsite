...
{
    public class TicketTemplateTablePropertiesGetBindingModel : PageSettingGetBinidingModel
    {
        public Guid TicketTemplateTableId { get; set; }
    }

    public class TicketTemplateTablePropertiesSetBindingModel : PageSettingSetBinidingModel
    {
        public Guid TicketTemplateTableId { get; set; }
