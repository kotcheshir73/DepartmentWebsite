...
namespace DepartmentWebCore.Services
{
    ...
    {
        private static IWebEducationDirectionService _serviceWED = new WebEducationDirectionService();
        ...
        public static List<MenuElementModel> GetMenuElementList()
        {
            ...
            var lecturerList = LecturerService.GetLecturers(new LecturerGetBindingModel());
            if (lecturerList.Result != null)
            ...
            var directionList = _serviceWED.GetEducationDirections(new WebEducationDirectionGetBindingModel());
            if (directionList.Succeeded)
                foreach (var directionItem in directionList.Result.List)
                {
