...
{
    public partial class ControlSeasonDates : UserControl
    {
        [Dependency]
        ...
        public ControlSeasonDates(ISeasonDatesService service)
		{
			InitializeComponent();
			_service = service;
		...
		{
            var form = Container.Resolve<FormSeasonDates>(
                new ParameterOverrides
                {
                    { "ayId", _ayId },
                    { "id", Guid.Empty }
                }
                .OnType<FormSeasonDates>());
