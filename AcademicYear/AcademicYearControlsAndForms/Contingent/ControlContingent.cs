...
{
    public partial class ControlContingent : UserControl
    {
        [Dependency]
        ...
        public ControlContingent(IContingentService service)
		{
			InitializeComponent();
			_service = service;
		...
		{
            var form = Container.Resolve<FormContingent>(
                new ParameterOverrides
                {
                    { "ayId", _ayId },
                    { "id", Guid.Empty }
                }
                .OnType<FormContingent>());
