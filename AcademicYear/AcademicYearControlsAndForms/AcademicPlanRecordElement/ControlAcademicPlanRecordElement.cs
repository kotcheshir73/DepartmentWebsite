...
{
    public partial class ControlAcademicPlanRecordElement : UserControl
    {
        [Dependency]
        ...
        public ControlAcademicPlanRecordElement(IAcademicPlanRecordElementService service)
        {
            InitializeComponent();
            _service = service;
        ...
        {
            var form = Container.Resolve<FormAcademicPlanRecordElement>(
                new ParameterOverrides
                {
                    { "aprId", _aprId },
                    { "id", Guid.Empty }
                }
                .OnType<FormAcademicPlanRecordElement>());
